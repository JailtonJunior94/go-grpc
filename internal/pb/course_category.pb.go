...
func (x *CategoryFetchRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x42, 0x6c, 0x61, 0x6e, 0x6b, 0x22, 0x26, 0x0a, 0x14, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x46, 0x65, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32,
	0xe7, 0x02, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2b, 0x0a, 0x0a, 0x43, 0x61, 0x74, 0x65,
	...
	0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x45, 0x0a, 0x11, 0x46, 0x65, 0x74, 0x63, 0x68, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x42, 0x79, 0x49, 0x44, 0x12, 0x18, 0x2e, 0x70, 0x62, 0x2e,
	0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x46, 0x65, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x47, 0x0a, 0x14,
	...
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x42, 0x69, 0x44,
...
var file_proto_course_category_proto_goTypes = []interface{}{
	...
	(*CategoryFetchRequest)(nil),  // 5: pb.CategoryFetchRequest
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	4, // 3: pb.CategoryService.Categories:input_type -> pb.Blank
	5, // 4: pb.CategoryService.FetchCategoryByID:input_type -> pb.CategoryFetchRequest
	1, // 5: pb.CategoryService.CreateCategoryStream:input_type -> pb.CreateCategoryRequest
	1, // 6: pb.CategoryService.CreateCategoryStreamBiDirectional:input_type -> pb.CreateCategoryRequest
	2, // 7: pb.CategoryService.CreateCategory:output_type -> pb.CategoryResponse
	3, // 8: pb.CategoryService.Categories:output_type -> pb.CategoryList
	2, // 9: pb.CategoryService.FetchCategoryByID:output_type -> pb.CategoryResponse
	3, // 10: pb.CategoryService.CreateCategoryStream:output_type -> pb.CategoryList
	0, // 11: pb.CategoryService.CreateCategoryStreamBiDirectional:output_type -> pb.Category
...
func file_proto_course_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_course_category_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CategoryFetchRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
